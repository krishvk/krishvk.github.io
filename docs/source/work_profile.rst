...
* Developed an offline generator **from scratch**, that generates code patterns at lightening speed
...
* Worked on standardising the methodologies used across the team
...
* Developed a log analyser tool as part of Master's thesis that automates the failure logs triaging
