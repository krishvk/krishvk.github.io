...
description: Three Random Program Generators (RPGs) for processor-level verification serving 50+ verification engineers across Synopsys ARC processor families since 2011.
---
...
- Supporting all processor features including multicore systems,
  ...
  [SIMD](https://en.wikipedia.org/wiki/SIMD), and multi-issue pipes
